...
class Writer:
    def write_csv(self, data, output_directory):
        ...
        with open(os.path.join(output_directory, "result.csv"), "w", encoding="utf8", newline='') as csv_file:
    ...
    def write_json(self, data, output_directory):
        ...
        with open(os.path.join(output_directory, "result.json"), "w", encoding="utf8") as file:
